        ...
        <div className="plans">
          ...
          <div className="plan">
            ...
            <ul className="plan-features">
              <li><span className="ck">✓</span>Unit 1 đầy đủ</li>
              <li><span className="ck">✓</span>Practice cơ bản mỗi ngày</li>
          ...
          <div className="plan featured">
            ...
            <ul className="plan-features">
              <li><span className="ck">✓</span>Tất cả Unit &amp; Adventure</li>
              <li><span className="ck">✓</span>Đủ 4 hoạt động luyện tập</li>
